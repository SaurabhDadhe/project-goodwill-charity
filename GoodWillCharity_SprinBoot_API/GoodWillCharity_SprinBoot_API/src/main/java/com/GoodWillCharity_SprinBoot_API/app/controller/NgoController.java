...
//        String userId = userDetails.getUsername(); // assuming username is set as UserId
//        String userRole = userDetails.getAuthorities().stream().findFirst().get().getAuthority();
//        System.out.println("tokenId= "+userId+" userRole= "+userRole);	
//        //String imgStatus = null;
//        if (userId.equals(id) || "Admin".equals(userRole)) {
////            if (ngo == null) {
////                return ResponseEntity.notFound().body("No Ngo Found With id = " + id);
////            }
//
//            try {
//            	Optional<Ngo> ngo = ngoService.getNgoById(id);
